...
var disabledSpinButton: objects.Button;
...
var spinResultsLabel: objects.Label;
var winsLabel: objects.Label;
var lossLabel: objects.Label;
var turnsLabel: objects.Label;

// reels
var reel1: objects.Reel;
var reel2: objects.Reel;
var reel3: objects.Reel;
...
function spin() {
    ...
    for (var spin = 0; spin < 3; spin++) {      // loop 3 times
        ...
        switch (outcome[spin]) {
            case 1:     // display blank on reel 
                betLine[spin] = "blank";
                increment++;
                break;
            case 2:     // display banana on reel 
                betLine[spin] = "banana";
                increment++;
                break;
            case 3:     // display cherry on reel 
                betLine[spin] = "cherry";
                increment++;
                break;
            case 4:     // display melon on reel
                betLine[spin] = "melon";
                increment++;
                break;
            case 5:     // display jackpot on reel 
                betLine[spin] = "jpot";
                increment++;
                break;
        }
...
///////////////////////////////////////////////////////////////
function hasEnoughCredit(betAmt: number): boolean {
    if (credit >= betAmt) {
        return true;
    }
    return false;
